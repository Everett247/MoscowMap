...
NSString * const TI_APPLICATION_ID = @"MoscowMap.com";
NSString * const TI_APPLICATION_PUBLISHER = @"everettrocks247";
NSString * const TI_APPLICATION_URL = @"http://";
NSString * const TI_APPLICATION_NAME = @"Map";
...
NSString * const TI_APPLICATION_GUID = @"4e1568e2-9ab5-4b0f-b4ea-48f95174038b";
